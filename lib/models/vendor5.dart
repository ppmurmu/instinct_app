...
Vendor5 vendor5FromJson(String str) => Vendor5.fromJson(json.decode(str));
...
class Vendor5 {
  ...
  factory Vendor5.fromJson(Map<String, dynamic> json) => Vendor5(
        ...
        ccmsList: json["ccms_list"] == null
            ? []
            : List<String>.from(json["ccms_list"].map((x) => x)),
      );
}
